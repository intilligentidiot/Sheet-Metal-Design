        ...
        <aside class="lg:w-1/3 space-y-12">
            ...
            <section class="bg-darkBg p-6 border border-white/10 rounded-custom" data-purpose="newsletter-widget">
                ...
                <form class="space-y-3" action="#" method="POST">
                    <input type="email" placeholder="email@company.com" required class="w-full bg-surface border-white/10 text-sm focus:ring-primary focus:border-primary rounded-custom text-white">
