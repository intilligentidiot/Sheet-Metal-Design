    ...
    <main class="pt-32 pb-24 min-h-screen px-6 max-w-4xl mx-auto">
        ...
        <div class="bg-surface p-8 md:p-12 rounded-custom border border-white/10 shadow-2xl">
            ...
            <form action="/api/contact" method="POST" class="space-y-6">
                ...
                <!-- Google reCAPTCHA v2 -->
                <div class="py-2">
                    <div class="g-recaptcha" data-sitekey="6Lexl6EsAAAAAL1FlWIrCfDJ5XpjLjWtDci3aVmU" style="transform:scale(0.85);-webkit-transform:scale(0.85);transform-origin:0 0;-webkit-transform-origin:0 0;"></div>
                </div>
